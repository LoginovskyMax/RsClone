export const createMail = (isUserData, message, username, passwordOrURL) => {
  const contentData = isUserData
    ? `<h2 class="rsgames__mail-message" style="justify-self: center;text-align: center;width: calc(100% - 140px);padding: 100px 70px 0;font-size: 24px;font-weight: 500;color: #0a005fcf;opacity: 0.9;margin: 0;">${message}</h2>
    <h3 class="rsgames__mail-submessage" style="justify-self: center;text-align: center;width: calc(100% - 140px);padding: 4px 70px 40px;font-size: 16px;font-weight: 500;color: #0a005fcf;opacity: 0.7;margin: 10px 0 0;line-height: 0.98;">
